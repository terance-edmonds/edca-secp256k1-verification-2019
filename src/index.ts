...
export class EcdsaSecp256k1VerificationKey2019 extends cryptoLd.LDKeyPair {
        ...
        if ((options as any).publicKeyHex || (options as any).privateKeyHex) {
            ...
            return new EcdsaSecp256k1VerificationKey2019({
                ...
                publicKeyBase58: publicKeyHex
                    ? base58.encode(Buffer.from(publicKeyHex, 'hex'))
                    : undefined,
                privateKeyBase58: privateKeyHex
                    ? base58.encode(Buffer.from(privateKeyHex, 'hex'))
                    : undefined
            });
        }
    ...
    > & {
        ...
        return new EcdsaSecp256k1VerificationKey2019({
            ...
            controller: `did:ethr:0x${Buffer.from(publicKeyCompressed).toString('hex')}#owner`,
            ...keyPairOptions
        });
    }
